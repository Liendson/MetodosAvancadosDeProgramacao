...
public class EditorDeCSVBuilder implements EditorBuilder {
    ...
    public Arquivo abrirArquivo(Arquivo arquivo) {
        if (this.arquivoAberto == null && arquivo.getPath().equals("csv")) {
            Arquivo arquivoParaAbrir = new ArquivoCSVBuilder();
