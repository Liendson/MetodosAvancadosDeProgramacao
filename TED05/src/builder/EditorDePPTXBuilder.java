...
public class EditorDePPTXBuilder implements EditorBuilder {
    ...
    public Arquivo abrirArquivo(Arquivo arquivo) {
        if (this.arquivoAberto == null && arquivo.getPath().equals("pptx")) {
            Arquivo arquivoParaAbrir = new ArquivoPPTXBuilder();
